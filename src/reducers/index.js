...
const deployedMillionairesProblemReducer = (
  deployedMillionairesProblem = null,
  action
) => {
...
const computeRichestMillionaireReducer = (
  richestMillionaire = null,
  action
) => {
