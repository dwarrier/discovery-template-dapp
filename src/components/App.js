...
import {
  initializeEnigma,
  initializeAccounts,
  deployMillionairesProblem
} from "../actions";
import "./MillionairesProblem";
...
class App extends Component {
  ...
  async componentDidMount() {
    ...
    const secretContractCount = await enigma.enigmaContract.methods
      .countSecretContracts()
      .call();
    const deployedMillionairesProblemAddress = (await enigma.enigmaContract.methods
      .getSecretContractAddresses(secretContractCount - 1, secretContractCount)
      .call())[0];
